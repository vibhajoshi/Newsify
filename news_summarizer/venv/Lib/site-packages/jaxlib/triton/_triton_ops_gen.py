...
class DotScaledOp(_ods_ir.OpView):
  ...
  def __init__(self, d, lhs, rhs, c, lhs_type, rhs_type, fastMath, *, lhs_scale=None, rhs_scale=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def dot_scaled(d, lhs, rhs, c, lhs_type, rhs_type, fast_math, *, lhs_scale=None, rhs_scale=None, loc=None, ip=None) -> _ods_ir.Value:
  return DotScaledOp(d=d, lhs=lhs, rhs=rhs, c=c, lhs_type=lhs_type, rhs_type=rhs_type, fastMath=fast_math, lhs_scale=lhs_scale, rhs_scale=rhs_scale, loc=loc, ip=ip).result
...
@_ods_cext.register_operation(_Dialect)
class ExperimentalDescriptorGatherOp(_ods_ir.OpView):
  OPERATION_NAME = "tt.experimental_descriptor_gather"
...
def experimental_descriptor_gather(result, desc, x_offsets, y_offset, *, loc=None, ip=None) -> _ods_ir.Value:
  return ExperimentalDescriptorGatherOp(result=result, desc=desc, x_offsets=x_offsets, y_offset=y_offset, loc=loc, ip=ip).result
...
@_ods_cext.register_operation(_Dialect)
class ExperimentalDescriptorScatterOp(_ods_ir.OpView):
  OPERATION_NAME = "tt.experimental_descriptor_scatter"
...
def experimental_descriptor_scatter(desc, x_offsets, y_offset, src, *, loc=None, ip=None) -> _ods_ir.Operation:
  return ExperimentalDescriptorScatterOp(desc=desc, x_offsets=x_offsets, y_offset=y_offset, src=src, loc=loc, ip=ip)
